...
int main(int argc, char const *argv[])
{
    ...
    cout << "Maximum integer in a 32-bit system a = " << a << endl;// suppose number x
    cout << "Minimum integer in a 32-bit system b = " << b << endl;// suppose y(negative no.)
    a++;
    cout << "Value of a after post increment = " << a << endl;    // output is y
